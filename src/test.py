...
input_image = cv2.imread("./test/thomas_shelby.png")
prompt = "astronaut"
...
cv2.imwrite("./test/astronaut_42_result.png", output_image)
expected_image = cv2.imread("./test/astronaut_42.png")

(score, _) = structural_similarity(output_image, expected_image, channel_axis = 2,full=True)
